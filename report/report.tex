...
ptrace code written for Linux will most likely not work on another UNIX such as
FreeBSD.
...
% XXX: Injection en modification nu al meenemen?
% \subsection{System call injection}
% 
% As stated previously, ptrace allows the tracer to modify the system calls
% and memory of a tracee. Being able to modify the memory and system calls
...
\textit{Tracy is a library that uses \textbf{ptrace(2)} to trace the system
    calls of a process.}
Tracy can inspect, modify and even inject system calls. Being able to
...
% XXX: Dit is er in gepaste van Enter: Tracy
