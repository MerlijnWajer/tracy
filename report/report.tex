...
programs have to make use of libraries, LD\_PRELAOD also has several downsides.
...
% XXX: voorbij.
keep track if the current event is a pre- or post-system call event
...
systemcall that has not been hooked.
...
post). Now follows is an explanation of system call injection from either state.
