...
being traced. Using \textbf{ptrace} the program tracing another program
can also modify the program being traced, including reading and writing
to the memory of the program and changing the system calls.
...
% Relevant omdat het een nieuw soort manier van o.a. transparant modifyen
% van programmas toestaat die niet mogelijk is met ldp en lastig is met
% de raw ptrace api. Onderzoeken omdat je naast alleen ``tracen'' ook
% leuke trucs uit kan halen (en die trucs maken het relevant want daar
% kan je dan een boel mee)
