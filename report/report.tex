...
% LD Preload is niet bruikbaar voor programmas die niet glibc gebruiken (zoals
% bijvoorbeeld alles van Go lang)
%
% ptrace api is platform dependent ook al is het POSIX en erg matig in gebruik.
%
% Tracy has lots of applications
