...
\begin{abstract}
    ...
    Tracy can trace, modify and inject system calls as well as perform several
    other useful tasks such as memory allocation in the child, modifying the
    memory of children and safely trace all (newly created) children of a
