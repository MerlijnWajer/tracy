...
they are created. To achieve this, the fork(2)\footnote{and related: vfork,
clone} system call must be executed in a controlled manner.
...
{RFC 1928 - SOCKS5 Protocol}}. However, the global flow is as follows (for
TCP connections.)
...
% Threaded tracer. Why? Lots of tracees doing lots of system calls
