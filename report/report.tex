...
To implement this feature, we make use system call injection as well as the
...
At this moment, we are still only tracing the child, but we can now use the
...
9or Program Counter) to their original position (that is, just after the
