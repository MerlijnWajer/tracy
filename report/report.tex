...
an application of Tracy called Soxy: a transparent SOCKS5 proxifier.
Chapter 5 presents an overview of feature that Tracy currently lacks and features
we would like to see implemented in Tracy. We end the paper with recap of
the paper, with a focus on goals set by the Tracy research project.
...
% Deze alinea is eigenlijk dubbel; gewoon weghalen?
